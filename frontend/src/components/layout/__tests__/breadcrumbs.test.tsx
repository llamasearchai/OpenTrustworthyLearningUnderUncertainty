...
describe('Breadcrumbs', () => {
  ...
  describe('PageBreadcrumbs', () => {
    it('should render explicit breadcrumb items and current page', () => {
      render(
        <PageBreadcrumbs
          items={[{ label: 'Scenarios', href: '/scenarios' }, { label: 'Scenario' }]}
          currentPage="Details"
        />,
        { wrapper: createWrapper(['/scenarios/test-123']) }
      );
      expect(screen.getByRole('navigation', { name: /breadcrumb/i })).toBeInTheDocument();
